...
public class MeshWriterJson extends MeshWriter{
     ...
     * @param charset carset to use in resulting JSON file.
            ...
            while(iter.hasNext()){
                ...
                if(coordsAvailable){
                    ...
                    for(int i = 0; i < coords.length; i++){
                        ...
                        //write separator if more elements in array
                        if(i < (coords.length - 1)) writer.write(",");
                    }
                ...
                if(textureCoordsAvailable){
                    ...
                    for(int i = 0; i < textureCoords.length; i++){
                        ...
                        //write separator if more elements in array
                        if(i < (textureCoords.length - 1)) writer.write(",");
                    }
                ...
                if(colorsAvailable){
                    ...
                    for(int i = 0; i < colors.length; i++){
                        ...
                        if(i < (colors.length - 1)) writer.write(",");
                    }
