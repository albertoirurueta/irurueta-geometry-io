...
public class ElementPLY {
     ...
     */
    private List<PropertyPLY> properties;
    ...
    public ElementPLY(String name, long nInstances){
        ...
        properties = new LinkedList<PropertyPLY>();
    }
    ...
    public List<PropertyPLY> getProperties() throws NotAvailableException{
        if(!arePropertiesAvailable()) throw new NotAvailableException();
        return properties;
    }
    ...
    public String toString(){
        ...
        Iterator<PropertyPLY> propertiesIterator = properties.iterator();
        
        while(propertiesIterator.hasNext()){
            //NOTE: properties already contain carrier return on their textual
            //representation
            builder.append(propertiesIterator.next().toString());
        }
